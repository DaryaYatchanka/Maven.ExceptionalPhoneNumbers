...
//                && String.valueOf(centralOfficeCode).length() == 3
//                && String.valueOf(phoneLineCode).length() == 4) {
            String PhoneNumber1 = "("+areaCode + ")-" + centralOfficeCode + "-" + phoneLineCode;
       //}
        try {
                return createPhoneNumber(PhoneNumber1);
            } catch (InvalidPhoneNumberFormatException e) {
                System.out.println(e);

                logger.warning(PhoneNumber1+ "is not a valid phone number");
            return null;
            }
